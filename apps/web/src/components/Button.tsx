...
const variantClasses: Record<Variant, string> = {
  ...
  secondary: "bg-white/5 hover:bg-white/10 text-white border-ms-line",
  ghost: "bg-transparent hover:bg-white/5 text-ms-muted hover:text-white border-transparent",
